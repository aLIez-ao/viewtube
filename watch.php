            ...
            <div class="description-box">
                <div class="row" style="margin-bottom: 0;">
                    <div class="col s12">
                        ...
                        <!-- También quitamos nl2br aquí para consistencia si usas pre-wrap en descripción -->
                        ...
                        <?php while($comment = $comments_result->fetch_assoc()): ?>
                            ...
                            <div class="comment-item">
                                ...
                                <div class="comment-body">
                                    ...
                                    <!-- CAMBIO: Quitamos nl2br() porque CSS white-space: pre-wrap ya maneja los saltos -->
