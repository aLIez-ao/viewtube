...
<div id="unsubscribeModal" class="modal">
    ...
    <div class="modal-footer"><a href="#!" class="modal-close waves-effect btn-flat">Cancelar</a><a href="#!" id="confirmUnsubscribe" class="waves-effect btn-flat blue-text text-darken-3">Anular suscripción</a></div>
</div>
<div id="shareModal" class="modal share-modal">
    <div class="modal-content">
        <div class="share-header">
            <h5>Compartir</h5><i class="material-icons modal-close">close</i>
        </div>
        <div class="social-row"><a href="https://wa.me/?text=<?php echo urlencode(BASE_URL . 'watch.php?id=' . $video_id); ?>" target="_blank" class="social-icon" title="WhatsApp">
                <div class="icon-circle whatsapp"><svg viewBox="0 0 24 24" width="24" height="24" fill="white">
            ...
            </a><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(BASE_URL . 'watch.php?id=' . $video_id); ?>" target="_blank" class="social-icon" title="Facebook">
                <div class="icon-circle facebook"><svg viewBox="0 0 24 24" width="24" height="24" fill="white">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg></div><span>Facebook</span>
            </a><a href="https://twitter.com/intent/tweet?text=Mira este video&url=<?php echo urlencode(BASE_URL . 'watch.php?id=' . $video_id); ?>" target="_blank" class="social-icon" title="X / Twitter">
                <div class="icon-circle twitter"><svg viewBox="0 0 24 24" width="20" height="20" fill="white">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg></div><span>X</span>
            </a><a href="mailto:?subject=Mira este video&body=<?php echo urlencode(BASE_URL . 'watch.php?id=' . $video_id); ?>" target="_blank" class="social-icon" title="Email">
                <div class="icon-circle email"><i class="material-icons" style="font-size: 24px; color: white;">email</i></div><span>Email</span>
            </a></div>
        <div class="copy-link-wrapper">
            <div class="input-container"><input type="text" id="shareUrlInput" value="<?php echo BASE_URL . 'watch.php?id=' . $video_id; ?>" readonly><button id="copyLinkBtn">Copiar</button></div>
        </div>
    </div>
</div>
